...
?><?if (IsModuleInstalled("advertising")):?> <?endif?><?$APPLICATION->IncludeComponent("bitrix:news.list", "slider", Array(
...
<h2>Наша продукция</h2>
 ...
 <?$APPLICATION->IncludeComponent(
	...
	Array(
		...
		"DETAIL_OFFERS_PROPERTY_CODE" => array(0=>"",1=>"INGRIDIENTS",2=>"WEIGHT",3=>"",),
		"DETAIL_PROPERTY_CODE" => array(0=>"WEIGHT",1=>"INGRIDIENTS",2=>"",),
