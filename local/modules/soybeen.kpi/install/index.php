...
Битрикс CModule*/
Class soybeen_kpi extends CModule {
    /*Обязательные свойства объекта модуля*/
    const MODULE_ID = "soybeen.kpi";
    var $MODULE_ID = "soybeen.kpi";
    var $MODULE_VERSION;
    ...
    function __construct()
    {
        ...
        $this->MODULE_NAME = GetMessage("soybeen.kpi_MODULE_NAME");
        $this->MODULE_DESCRIPTION =
            GetMessage("soybeen.kpi_MODULE_DESC");
        $this->PARTNER_NAME = GetMessage("soybeen.kpi_PARTNER_NAME");
        $this->PARTNER_URI = GetMessage("soybeen.kpi_PARTNER_URI");
    }
